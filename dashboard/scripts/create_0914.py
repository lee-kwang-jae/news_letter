...
<div class="mom-issue-card">
<h4>2️⃣ 정부·하남시 '2026 출산지원금 &amp; 첫만남이용권·부모급여' 지원 확대 소식에 맘카페 관심 집중</h4>
<div class="mom-detail"><strong>현황:</strong> 2026년 정부 첫만남이용권(첫째 200만 원, 둘째 이상 300만 원 바우처) 및 부모급여(0세 월 100만 원, 1세 월 50만 원)와 하남시 자체 출산장려금(첫째 50만 원, 둘째 100만 원, 셋째 200만 원 등) 통합 지원 소식이 전해지면서 예비 부모와 출산 가구의 관심이 집중되었습니다.</div>
<div class="mom-point">💡 주민 포인트: 하남시 출산장려금과 정부 첫만남이용권 중복 지원 혜택 및 복지로·동 행정복지센터 원스톱 신청으로 초기 양육비 부담 대폭 완화.</div>
<div class="mom-reaction">💬 주민 반응: "첫째 출산 예정인데 하남시 장려금이랑 정부 첫만남이용권 둘 다 받을 수 있어 든든하네요!", "신청 절차 깔끔 정리 꿀팁 정보 감사해요" 맘카페 환호.</div>
</div>
