...
update_file('d:/github/newsletter/newsletter/dashboard/scripts/remove_floating_top_btn.py')
update_file('d:/github/newsletter/newsletter/dashboard/scripts/add_sticky_header_and_top_btn.py')
