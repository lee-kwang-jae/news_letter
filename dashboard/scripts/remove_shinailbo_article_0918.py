...
<div class="img-box" style="width: 240px; flex-shrink: 0;">
<img src="./images/091806.jpg" alt="감일건강생활지원센터 임산부 요가교실 안내" style="width: 100%; height: 210px; object-fit: contain; background-color: #ffffff; border-radius: 12px; border: 1px solid #cbd5e0; cursor: pointer;" onclick="openImageModal(this.src)" title="클릭하여 원본 보기">
</div>
</div>
<div class="source">
📌 출처: 국제뉴스 (강정훈 기자)
