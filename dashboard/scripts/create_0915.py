...
<!-- 지역 뉴스 기사 3 (하남시 보호견 입양 캠페인) -->
<div class="article-card">
<div class="badge">📰 동물복지/행정</div>
<h3><a href="https://www.joongdo.co.kr/web/view.php?key=20260913010004063" target="_blank" style="color: inherit; text-decoration: none;">하남시, 보호견 입양 활성화 캠페인 실시… 따뜻한 가족 찾기 총력</a></h3>
<div class="summary" style="text-align: left; word-break: keep-all; letter-spacing: -0.3px;">
하남시가 유기 및 보호동물의 입양 비율을 높이고 올바른 반려동물 문화를 확산하기 위한 오프라인 입양 홍보 캠페인을 펼치고 있습니다. 시민들의 관심이 실질적인 입양으로 이어질 수 있도록 입양 전후 성과 관리와 사후 지원을 대폭 강화할 방침입니다.
<div style="margin-top: 12px; font-size: 0.9em; color: #718096;"><a href="https://www.joongdo.co.kr/web/view.php?key=20260913010004063" target="_blank" style="color: #3182ce; font-weight: bold; text-decoration: none;">기사 원문 보기 (중도일보) →</a></div>
</div>
<div class="source">
📌 출처: 중도일보 (이인국 기자)
</div>
