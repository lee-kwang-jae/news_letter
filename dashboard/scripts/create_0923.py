...
<h3><a href="javascript:void(0)" onclick="playNewsletterVideo()" style="color: inherit; text-decoration: none;" title="클릭하여 페이지에서 영상 재생">"전 국토를 반나절 생활권으로!" 현장 숏폼</a></h3>
<div class="summary" style="text-align: left; word-break: keep-all; letter-spacing: -0.3px;">
<div style="margin-top: 14px; margin-bottom: 12px; display: flex; justify-content: center;">
  <div id="yt-container-AnKX7rcqFG8" style="position: relative; width: 100%; max-width: 320px; aspect-ratio: 9/16; border-radius: 16px; overflow: hidden; border: 1px solid #cbd5e0; box-shadow: 0 8px 24px rgba(0,0,0,0.2); display: block; background: #000;">
    <video id="video-AnKX7rcqFG8" poster="images/shorts_0923_poster.jpg" controls playsinline webkit-playsinline="true" x5-playsinline="true" preload="metadata" style="width: 100%; height: 100%; object-fit: cover; border-radius: 16px;">
      <source src="images/shorts_0923.mp4" type="video/mp4">
      <iframe src="https://www.youtube.com/embed/AnKX7rcqFG8?feature=oembed" title="전 국토를 반나절 생활권으로! #하남갑 #이광재" style="width: 100%; height: 100%; border: 0;" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
    </video>
  </div>
</div>
<div style="margin-top: 12px; font-size: 0.9em; color: #718096;"><a href="https://youtube.com/shorts/AnKX7rcqFG8?si=8pSb2EYaualcTkax" target="_blank" style="color: #3182ce; font-weight: bold; text-decoration: none;">유튜브에서 보기 (이광재 TV) →</a></div>
</div>
<div class="source">
...
<!-- 지역 뉴스 기사 2 (오마이뉴스: 하남시, 추석 연휴 80명 비상근무... 안전·의료·교통 8개 대책반 가동) -->
<div class="article-card" style="margin-top: 16px;">
<div class="badge">📰 지방행정/민생안전</div>
<h3><a href="https://www.ohmynews.com/NWS_Web/View/at_pg.aspx?CNTN_CD=A0003269676&amp;CMPT_CD=P0010&amp;utm_source=naver&amp;utm_medium=newsearch&amp;utm_campaign=naver_news" target="_blank" style="color: inherit; text-decoration: none;">하남시, 추석 연휴 80명 비상근무... 안전·의료·교통 8개 대책반 가동</a></h3>
<div class="summary" style="text-align: left; word-break: keep-all; letter-spacing: -0.3px;">
하남시가 오는 24일부터 27일까지 나흘간 추석 연휴 종합대책을 수립하고 80명 규모의 비상근무체계를 가동합니다. 안전·물가·교통·환경·의료·급수 등 8개 분야 비상상황실을 가동해 명절 물가 점검, 비상진료 체계 유지, 25일 생활쓰레기 수거 중단 대응, 온누리상품권 환급 및 하머니 캐시백 등 종합 민생 종합 지원에 나섭니다.
<div style="margin-top: 12px; font-size: 0.9em; color: #718096;"><a href="https://www.ohmynews.com/NWS_Web/View/at_pg.aspx?CNTN_CD=A0003269676&amp;CMPT_CD=P0010&amp;utm_source=naver&amp;utm_medium=newsearch&amp;utm_campaign=naver_news" target="_blank" style="color: #3182ce; font-weight: bold; text-decoration: none;">기사 원문 보기 (오마이뉴스) →</a></div>
</div>
<div class="source">
📌 출처: 오마이뉴스 (박정훈 기자)
</div>
...
<!-- 문화 기사 2 (하남시미사강변종합사회복지관: 2026 함께RUN 러닝 페스티벌) -->
<div class="article-card" style="background-color: #f0fdf4; border-left: 4px solid #319795; margin-top: 16px;">
<div class="badge" style="background-color: #e6fffa; color: #2c7a7b; border: 1px solid #b2f5ea;">🏃‍♀️ 2026.10.11(일) 09:00 | 스포츠/축제</div>
<h3 style="margin-top: 6px;"><a href="https://www.hmgcwc.or.kr/notice/502" target="_blank" style="color: inherit; text-decoration: none;">하남시미사강변종합사회복지관 2026 함께RUN 러닝 페스티벌 개최</a></h3>
<div class="summary flex-summary" style="text-align: left; word-break: keep-all; letter-spacing: -0.3px; background: rgba(255, 255, 255, 0.75); border: 1px solid rgba(178, 245, 234, 0.6); color: #22543d;">
<div style="flex: 1;">
<b>"달리는 오늘, 더 나은 내일을 함께! 2026 함께RUN 러닝 페스티벌"</b><br/>
하남미사경정공원에서 지역주민 여러분과 건강한 활력을 나누기 위한 러닝 축제가 펼쳐집니다. 런콥컴퍼니 박명현 대표의 러닝 클래스와 'My First Run' 코너 등 풍성한 행사와 11만원 상당 기념품이 제공되오니 많은 참여 바랍니다.<br/><br/>
<b>🗓 일시:</b> 2026년 10월 11일(일) 09:00<br/>
<b>📍 장소:</b> 하남미사경정공원<br/>
<b>🏃‍♂️ 모집종목:</b> 5KM (4만 원), 10KM (5만 원)<br/>
<b>🎁 혜택:</b> 참가자 전원 11만원 상당 기념품 증정 (기념티, 양말, 에너지젤, 에코백 등)<br/>
<b>🗓 접수기간:</b> 2026년 9월 30일(수) 12:00까지 (선착순 마감)<br/>
<b>☎️ 접수문의:</b> 02-515-9033 / 카카오톡 '런콥컴퍼니'
<div style="margin-top: 12px; font-size: 0.9em; color: #718096;"><a href="https://www.hmgcwc.or.kr/notice/502" target="_blank" style="color: #3182ce; font-weight: bold; text-decoration: none;">상세 안내 및 신청하기 (하남시미사강변종합사회복지관) →</a></div>
</div>
<div class="img-box" style="width: 240px; flex-shrink: 0;">
<img src="images/092302.jpg" alt="2026 함께RUN 러닝 페스티벌" style="width: 100%; height: auto; max-height: 260px; object-fit: contain; background-color: #ffffff; border-radius: 12px; border: 1px solid #cbd5e0; cursor: pointer;" onclick="openImageModal(this.src)" title="클릭하여 원본 보기">
</div>
</div>
<div class="source">
📌 출처: 하남시미사강변종합사회복지관
...
# Update playNewsletterVideo to target new video ID
content = content.replace(
    "document.getElementById('video-lhLfoDigJc4')",
    "document.getElementById('video-AnKX7rcqFG8') || \n            document.getElementById('video-lhLfoDigJc4')"
)
