...
<h4>1️⃣ "노후주택 집수리 지원 혜택 대박!" 하남시 집수리지원 및 침수·단열 보강 소식에 맘카페 호평</h4>
<div class="mom-detail"><strong>현황:</strong> 가구당 최대 1,200만 원(공사비 90% 지원)을 지원하는 하남시 소규모 노후주택 집수리 지원사업과 반지하 차수판, 옥상 방수, 단열 창호 지원 정보가 맘카페에 공유되었습니다.</div>
<div class="mom-point">💡 주민 포인트: 노후 단독·다세대주택 대상 맞춤형 주거환경 개선 및 에너지 효율 향상 지원.</div>
<div class="mom-reaction">💬 주민 반응: "친정 집 옥상 방수랑 창호 교체 알아보고 있었는데 지원 사업 꼭 신청해야겠어요!", "반지하 차수판 설치 지원 정말 유용합니다" 긍정 반응 폭발.</div>
</div>

<div class="mom-issue-card">
<h4>2️⃣ "이번 주말 미사경정공원으로 러닝&amp;소풍 가요!" 20일 '2026 한돈런' 개최 소식 주목</h4>
<div class="mom-detail"><strong>현황:</strong> 9월 20일 미사경정공원에서 열리는 '2026 한돈런' 러닝 페스티벌과 참가자 한돈 도시락 제공, 10개 브랜드 체험 이벤트 소식이 맘카페 회원들 사이에 활발히 공유되었습니다.</div>
<div class="mom-point">💡 주민 포인트: 온 가족 미사경정공원 가을 나들이 및 다채로운 힐링 체험.</div>
<div class="mom-reaction">💬 주민 반응: "경정공원 산책 겸 주말에 아이들이랑 한돈런 구경 가야겠어요!", "한돈 도시락도 선물로 준다니 가족 주말 나들이로 최고네요" 호평.</div>
</div>

<div class="mom-issue-card">
<h4>3️⃣ "추석 명절 스타필드 하남 볼거리 풍성!" 벌룬 아트 전시 &amp; 한가위 문화 바캉스 소식 화제</h4>
<div class="mom-detail"><strong>현황:</strong> 추석 연휴 스타필드 하남에서 펼쳐지는 대형 벌룬 아트 전시와 세계 문화 체험 행사 소식이 엄마들 사이에서 인기 명소 정보로 빠르게 확산 중입니다.</div>
<div class="mom-point">💡 주민 포인트: 연휴 기간 아이들과 함께 즐길 수 있는 안성맞춤 실내 문화 바캉스.</div>
<div class="mom-reaction">💬 주민 반응: "알록달록 예쁜 벌룬 전시 아이들이 진짜 좋아하겠어요", "명절 장도 보고 아이들 사진 찍어주러 스타필드 가야겠네요" 기대감 만발.</div>
</div>
</div>"""
...
<div class="img-box" style="width: 240px; flex-shrink: 0; display: flex; flex-direction: column; gap: 8px;">
<img src="./images/091704.jpg" alt="찾아가는 마을학교 안내" style="width: 100%; height: 100px; object-fit: cover; background-color: #ffffff; border-radius: 8px; border: 1px solid #cbd5e0; cursor: pointer;" onclick="openImageModal(this.src)" title="클릭하여 원본 보기">
<img src="./images/091705.jpg" alt="찾아가는 마을학교 포스터" style="width: 100%; height: 100px; object-fit: cover; background-color: #ffffff; border-radius: 8px; border: 1px solid #cbd5e0; cursor: pointer;" onclick="openImageModal(this.src)" title="클릭하여 원본 보기">
</div>
</div>
<div class="source">
📌 출처: 하남시청
