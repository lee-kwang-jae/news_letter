...
<div class="mom-issue-card">
<h4>2️⃣ "검단산·남한산성 다 함께 뛰어요" 12월 '하남 국제 트레일런 페스티벌' 개최 소식 화제</h4>
<div class="mom-detail"><strong>현황:</strong> 황영조 감독이 코스를 디자인한 미사경정공원~검단산~남한산성 12월 '하남 국제 트레일런 페스티벌' 개최 소식이 알려지며 운동과 건강에 관심 높은 맘카페 회원들 사이에서 큰 화제를 모았습니다.</div>
<div class="mom-point">💡 주민 포인트: 5·10km 로드 및 15·28km 트레일 코스로 온 가족이 함께 참여하는 스포츠 축제.</div>
<div class="mom-reaction">💬 주민 반응: "남편이랑 아이랑 5km 코스 신청해 봐야겠어요!", "검단산 러닝 코스 너무 멋질 것 같네요" 기대감 표출.</div>
</div>
